...
(function ($) {
    ...
    var $navbar_variants_colors = createSkinBlock(navbar_all_colors, function (e) {
        ...
        sendDataSetting({'main_header_color' : color+' '+ nav_type});
    })
    ...
    var $navbar_border = $('<input />', {
        ...
        sendDataSetting({'main_header_border' : main_header_border});
    })
    ...
    $container.append(createSkinBlock(sidebar_colors, function () {
        ...
        sendDataSetting({'main_sidebar_color' : sidebar_class});
    }))
    ...
    $container.append(createSkinBlock(logo_skins, function () {
        ...
        $logo.addClass(color)
        sendDataSetting({'logo_color' : color});
    }).append($clear_btn))
    ...
    function sendDataSetting(setting) {
        if (url !== undefined) {
            var array_keys = ['logo_color', 'main_sidebar_color', 'main_header_border', 'main_header_color'];
            $.post(url, {setting: setting, array_keys: array_keys}, function (response) {});
        }
    }
})(jQuery);
